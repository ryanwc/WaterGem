...
2. If you are working on a Linux or Mac OS X machine and do not already havr the Google App Engine SDK for Python installed:
...
3. If you are working on a Windows machine and do not already havr the Google App Engine SDK for Python installed:
